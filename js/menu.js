...
// Make sure this logo variable is accessible globally within this module
 ...
 * This function is called when the username is successfully entered.
 */
function menu(){
    // First, ensure all existing canvas elements are removed
    removeAll(); 
    
    // Now add the main menu elements
    add(logo); // Logo will remain for now, hidden later by username save
...
// Don't call menu() immediately on script load. It will be called after username entry.
...
function playButtonHit(){
    ...
    add(logo); // Re-add logo for map selection screen
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.endsWith('index.html') || window.location.pathname === '/') {
        ...
        initMenuUI(); // Initialize the HTML-based menu based on username
        // The canvas-based 'menu()' function is now called *inside* initMenuUI
        // after a username is determined, or after it's entered and saved.
